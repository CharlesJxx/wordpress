                        ...
                        <div class="main-menu floatright">
                            <nav>
                                <ul>
                                    ...
                                    <li class="active"><a href="index.html">Pages <i class="fa fa-angle-down"></i></a>
                                        <ul class="sub-menu">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <ul class="breadcrumb-list">
                <li><a href="index.html">Home</a></li>
                <li class="bread-text">our history</li>
            </ul>
        </div><!-- /container -->
    </div><!-- /slider -->
            ...
            <div class="row mb-30">
                <div class="left-sidebar">
                    <div class="about-sidebar mb-30">
                        <ul class="sidebar">
                            <li><a href="about.html">About us</a></li>
                            <li><a href="history.html"><span class="yellow">History</span></a></li>
                            <li><a href="partners.html">Partners</a></li>
                            <li><a href="team.html">Team</a></li>
                ...
                <div class="right-sidebar">
                    ...
                    <div class="history-img">
                        <img src="img/about/abt4.jpg" class="img-responsive mb-30" alt="">
                        <a href="#"><img src="img/ico/ytube.png" class="img-responsive ytube" alt=""></a>
                    </div>
                    ...
                    <div class="history-box">
                        <div class="row">
                            ...
                            <div class="history-con">
                                <div class="hcontent">
                                    <h2>BECOME A LEADING COMPANY</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                    consequat.</p>    
