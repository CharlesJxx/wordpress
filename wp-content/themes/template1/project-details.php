...
<body>
                        ...
                        <div class="main-menu floatright">
                            <nav>
                                <ul>
                                    ...
                                    <li class="active"><a href="projects.html">Projects <i class="fa fa-angle-down"></i></a>
                                        <ul class="sub-menu">
    ...
    <div class="breadcrumb">
        <div class="container">
            <h1 class="white">PROJECTS DETAILS</h1>
            <ul class="breadcrumb-list">
                <li><a href="index.html">Home</a></li>
                <li class="bread-text">PROJECTS DETAILS</li>
            </ul>
        </div><!-- /container -->
    </div><!-- /slider -->
    ...
    <section class="project-area">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row mt-20" id="project-details-bottom">
                        <div class="project-details-bottom">
                            ...
                            <div class="history-img mt-30">
                                <img src="img/project/project1.jpg" class="img-responsive" alt="">
                ...
                <div class="left-sidebar project-details">
                    ...
                    <div class="contact-area">
                        <h3 class="mb-20">OUR OFFICES</h3>
                        <div class="contact-item">
                            <h5>Address:</h5>
                            <span>45th Ave, Melbourne</span>    
                        </div><!-- /contact-item -->
                        <div class="contact-item">
                            <h5>Email:</h5>
                            <span>info@contour.com</span>    
                        </div><!-- /contact-item -->
                        <div class="contact-item">
                            <h5>Phone:</h5>
                            <span>(+61) 123 234 890</span>    
                        </div><!-- /contact-item -->
                    </div><!-- /contact-area -->
                </div>
            </div><!-- /row -->
