...
<body>
                        ...
                        <div class="main-menu floatright">
                            <nav>
                                <ul>
                                    ...
                                    <li class="active"><a href="news.html">News <i class="fa fa-angle-down"></i></a>
                                        <ul class="sub-menu">
    ...
    <div class="breadcrumb">
        <div class="container">
            <h1 class="white">NEWS DETAILS</h1>
            <ul class="breadcrumb-list">
                <li><a href="index.html">Home</a></li>
                <li class="bread-text">NEWS DETAILS</li>
            </ul>
        </div><!-- /container -->
    </div><!-- /slider -->
            ...
            <div class="row">
                <div class="right-sidebar">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-img">
                            <img src="img/slider/slider7.jpg" alt="" class="img-responsive">
                        </div>
                        <div class="date">
                            <h2>15</h2>
                            <small>JAN</small>
                    ...
                    <h2>ROOFS &amp; HALLS CONSTRUCTING</h2>
                    <ul class="post-subtext">
                        <li>August 20, 2017</li>
                    ...
                    cillum dolore eu fugiat nulla <span class="meriwether">pariatur Excepteur sint occaecat cupidatat non
                    proident, sunt in culpa qui officia deserunt mollit</span> anim id est laborum. 
                    ...
                    <h3 class="mb-30">3 Comments</h3>

                    <div class="media mb-30">
                        <div class="media-left">
                          <img src="img/client/client1.jpg" class="media-object" alt="">
                        </div>
                        
                        <div class="media-body">
                            <h4 class="media-heading">FRANK HUGEMAN</h4>
                            <p class="meriwether">December 15, 2017 &nbsp;&nbsp;&nbsp; <span class="pull-right"><a href="#">Reply</a></span></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            consequat.</p>
                            <ul class="media-list">
                                <li><i class="fa fa-thumbs-up"></i> 23</li>
                                <li><i class="fa fa-comments-o"></i> 10</li>
                                <li><i class="fa fa-heart-o red"></i> 75</li>
                            </ul>
                        </div><!-- /media-body -->
                    </div><!-- /media --><hr>
                    ...
                    <div class="media mb-30">
                        <div class="media-left">
                          <img src="img/client/client2.jpg" class="media-object" alt="">
                        </div>
                        
                        <div class="media-body">
                            <h4 class="media-heading">MARK RUFALO</h4>
                            <p class="meriwether">January 15, 2018 &nbsp;&nbsp;&nbsp; <span class="pull-right"><a href="#">Reply</a></span></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            consequat.</p>
                            <ul class="media-list">
                                ...
                                <li><i class="fa fa-comments-o"></i> 04</li>
                                <li><i class="fa fa-heart-o"></i> 23</li>
                            </ul>
                        </div><!-- /media-body -->
                    </div><!-- /media --><hr>
                    ...
                    <div class="media mb-30">
                        <div class="media-left">
                          <img src="img/client/client3.jpg" class="media-object" alt="">
                        </div>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="recent-post">
                        ...
                        <div class="recent-box">
                            <small><i class="fa fa-clock-o"></i> &nbsp;August 12, 2018</small>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor.</p>
                        </div><!-- /recent-box -->
            ...
            <div class="row">
                ...
                <div class="footer-con mb-30">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="painting.html">House Painting</a></li>
                        <li><a href="contracting.html">General Contracting</a></li>
                        <li><a href="plan.html">Plan Modelling</a></li>
                        <li><a href="about.html">About Us</a></li>
