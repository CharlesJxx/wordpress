        ...
        <div class="container">
            ...
            <div class="row mb-50" id="three-icons">
                <div class="three-icons">
                    <img src="img/ico/map.png" class="img-responsive mb-20" alt="">
                    <h3 class="mb-20">HEAD OFFICE</h3><hr>
                    <p>45 South avenue,La plaza Hotel, Melboune, Victoria, Australia - 345 097.</p>
                </div>

                <div class="three-icons">
                    <img src="img/ico/phone.png" class="img-responsive mb-20" alt="">
                ...
                <div class="three-icons">
                    <img src="img/ico/mail.png" class="img-responsive mb-20" alt="">
                    <h3 class="mb-20">HEAD OFFICE</h3><hr>
