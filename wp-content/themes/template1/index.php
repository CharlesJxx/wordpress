                    ...
                    <div class="project-grid project-grid-home">
                        <div class="project-wrapper">
                            <div class="project-img">
                                ...
                                <div class="project-caption">
                                    <a class="protfolio-icon test-popup-link" href="<?php bloginfo('template_url'); ?>/img/works/2.jpg">
                                        <i class="fa fa-arrows-alt" ></i>
                                    </a>
                                    <h3><a href="project-details.html">Green House</a></h3>   
                                    <span>Construction</span>                                   
                    ...
                    <div class="project-grid project-grid-home">
                        <div class="project-wrapper">
                            <div class="project-img">
                                ...
                                <div class="project-caption">
                                    <a class="protfolio-icon test-popup-link" href="<?php bloginfo('template_url'); ?>/img/works/3.jpg">
                                        <i class="fa fa-arrows-alt" ></i>
                                    </a>
                                    <h3><a href="project-details.html">Green House</a></h3>   
                                    <span>Construction</span>                                   
                    ...
                    <div class="project-grid project-grid-home">
                        <div class="project-wrapper">
                            <div class="project-img">
                                ...
                                <div class="project-caption">
                                    <a class="protfolio-icon test-popup-link" href="<?php bloginfo('template_url'); ?>/img/works/4.jpg">
                                        <i class="fa fa-arrows-alt" ></i>
                                    </a>
                                    <h3><a href="project-details.html">Green House</a></h3>   
                                    <span>Construction</span>                                   
                    ...
                    <div class="project-grid project-grid-home">
                        <div class="project-wrapper">
                            <div class="project-img">
                                ...
                                <div class="project-caption">
                                    <a class="protfolio-icon test-popup-link" href="<?php bloginfo('template_url'); ?>/img/works/5.jpg">
                                        <i class="fa fa-arrows-alt" ></i>
                                    </a>
                                    <h3><a href="project-details.html">Green House</a></h3>   
                                    <span>Construction</span>                                   
                    ...
                    <div class="project-grid project-grid-home">
                        <div class="project-wrapper">
                            <div class="project-img">
                                ...
                                <div class="project-caption">
                                    <a class="protfolio-icon test-popup-link" href="<?php bloginfo('template_url'); ?>/img/works/6.jpg">
                                        <i class="fa fa-arrows-alt" ></i>
                                    </a>
                                    <h3><a href="project-details.html">Green House</a></h3>   
                                    <span>Construction</span>                                   
            ...
            <div class="row">
                <div class="popular-con">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-img">
                            <a href="#"><img src="<?php bloginfo('template_url'); ?>/img/blog/news1.jpg" alt="" /></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-info">
                ...
                <div class="popular-con">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-img">
                            <a href="#"><img src="<?php bloginfo('template_url'); ?>/img/blog/news2.jpg" alt="" /></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-info">
                ...
                <div class="popular-con">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-img">
                            <a href="#"><img src="<?php bloginfo('template_url'); ?>/img/blog/news3.jpg" alt="" /></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-info">
